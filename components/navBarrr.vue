...
<template>
  ...
  >
    <nav class="flex flex-row w-full items-center">
      <div
        class="max-w-screen-xl flex flex-wrap grow items-center justify-between mx-auto p-4"
      >
        <NuxtLink to="" class="flex items-center space-x-3 rtl:space-x-reverse">
          ...
          <img
            class="w-6 sm:w-12"
            src="/ahha-high-resolution-logo-transparent (10).svg"
            alt="Avatar"
          />
        </NuxtLink>
        ...
        <div class="flex items-center gap-4">
          ...
          >
            <ClientOnly>
              <UChip
                :size="windowWidth <= 640 ? 'xs' : 'xl'"
                :text="useStore.user ? useStore.user.username : ''"
              >
