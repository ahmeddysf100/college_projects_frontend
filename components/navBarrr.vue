...
const size_toggle = ref()
const open = ref(false);
const windowWidth = ref();
onMounted(() => {
  if (process.client) {
    windowWidth.value = window.innerWidth;
    size_toggle.value = windowWidth.value <= 640 ? '7px' : '15px'
  ...
  <ClientOnly>
    <div
      ...
      <nav class="flex flex-row w-full items-center">
        ...
        <UButton class="mx-3 " size="xs" color="white" variant="ghost" square aria-label="Theme">
          <!-- <UToggle on-icon="i-heroicons-moon-solid" off-icon="i-heroicons-sun-solid" :model-value="isDark"
            color="indigo" :size="windowWidth <= 640 ? 'sm' : 'lg'" /> -->

          <label :style="{ '--toggle-size': size_toggle }" class="theme-switch  ">
            <input type="checkbox" :checked="true" class="theme-switch__checkbox ">
            <div @click="isDark = !isDark" class="theme-switch__container ">
