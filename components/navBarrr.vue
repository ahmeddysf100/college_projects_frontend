...
<template>
   <div
      ...
      <nav class="flex flex-row w-full items-center">
         <div class="max-w-screen-xl flex  flex-wrap grow items-center justify-between mx-auto p-4">
            ...
            <div class="flex items-center gap-4">
               <UDropdown v-if="useStore.user" mode="hover" :items="items"
                  ...
                  <UChip size="xl" :text="useStore.user ? useStore.user.username : ''">
         ...
         <ClientOnly>
            <UButton class=" mx-3 p-2" size="xs" color="white" variant="solid" square aria-label="Theme"
               @click="isDark = !isDark">
         ...
         <UButton variant="gost" class=" block lg:hidden  mr-3"  @click="open = !open" >
            <svg v-if="open"  xmlns="http://www.w3.org/2000/svg" class=" w-7 h-7"  viewBox="0 0 16 16"><path fill="currentColor" d="M5.28 4.22a.75.75 0 0 0-1.06 1.06L6.94 8l-2.72 2.72a.75.75 0 1 0 1.06 1.06L8 9.06l2.72 2.72a.75.75 0 1 0 1.06-1.06L9.06 8l2.72-2.72a.75.75 0 0 0-1.06-1.06L8 6.94z"/></svg>         
            <svg v-else  xmlns="http://www.w3.org/2000/svg" class=" w-7 h-7" viewBox="0 0 16 16"><path fill="currentColor" fill-rule="evenodd" d="M2 3.75A.75.75 0 0 1 2.75 3h10.5a.75.75 0 0 1 0 1.5H2.75A.75.75 0 0 1 2 3.75M2 8a.75.75 0 0 1 .75-.75h10.5a.75.75 0 0 1 0 1.5H2.75A.75.75 0 0 1 2 8m0 4.25a.75.75 0 0 1 .75-.75h10.5a.75.75 0 0 1 0 1.5H2.75a.75.75 0 0 1-.75-.75" clip-rule="evenodd"/></svg>
         </UButton>
